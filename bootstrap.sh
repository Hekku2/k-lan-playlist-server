...
#Start services
su - vagrant -c 'cd k-lan-playlist-server/PlayerService/ && pm2 -s start src/server.js --watch'
su - vagrant -c 'cd k-lan-playlist-server/UserService/ && pm2 -s start src/server.js --watch'
